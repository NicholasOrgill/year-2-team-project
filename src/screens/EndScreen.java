...
public class EndScreen extends Screen {
	...
	public EndScreen(GameObject gameObject) {
		...
		player1Text = new SystemTextScore(getScreenWidth() - 200, 120, "" + player1Score);
		player1Text.shine();
		...
		for(int i = 0 ; i < howWellBefore.length ; i ++) howWellBefore[i] = 0;
	...
	public void draw(Graphics context) {
		...
		for(int i = 100 ; i < 100 + 340 + 10 ; i+= 50) {
			...
			context.setColor(new Color(ColorPack.PRIMARY.getRed(), ColorPack.PRIMARY.getGreen(), ColorPack.PRIMARY.getBlue(), height));
