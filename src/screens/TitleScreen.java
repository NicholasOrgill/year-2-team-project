...
public class TitleScreen extends Screen {
	...
	public TitleScreen(GameObject gameObject) {
		...
		beatnetf = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/beatnet_full.png"));
		beatnetf.setScreenSize(getScreenWidth(), getScreenHeight());
		beatnetf.setOpacity(0);

		beatnetfi = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/beatnet_full.png"));
		beatnetfi.setScreenSize(getScreenWidth(), getScreenHeight());
		beatnetfi.setOpacity(0);
		beatnetfi.setSize(1.01f);

		beatnet = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/beatnet.png"));
		beatnet.setScreenSize(getScreenWidth(), getScreenHeight());
		beatnet.setOpacity(0);

		beatne = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/beatne.png"));
		beatne.setScreenSize(getScreenWidth(), getScreenHeight());
		beatne.setOpacity(0);

		beatn = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/beatn.png"));
		beatn.setScreenSize(getScreenWidth(), getScreenHeight());
		beatn.setOpacity(0);

		beat = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/beat.png"));
		beat.setScreenSize(getScreenWidth(), getScreenHeight());
		beat.setOpacity(0);

		bea = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/bea.png"));
		bea.setScreenSize(getScreenWidth(), getScreenHeight());
		bea.setOpacity(0);

		be = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/be.png"));
		be.setScreenSize(getScreenWidth(), getScreenHeight());
		be.setOpacity(0);

		b = new ImageSprite(getScreenWidth() / 2, (int) (getScreenHeight() * 0.4),
				ImageLoader.loadImageFromResource("src/res/images/b.png"));
